...
SHLIB_EXT=
PLATFORM=VC-WIN32
OPTIONS= no-ec_nistp_64_gcc_128 no-gmp no-jpake no-krb5 no-md2 no-rc5 no-rfc3779 no-sctp no-shared no-store no-zlib no-zlib-dynamic
CONFIGURE_ARGS=VC-WIN32 no-shared
SHLIB_TARGET=
